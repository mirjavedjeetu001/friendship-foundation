                ...
                <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                    <div class="flex items-center space-x-4">
                        @if($member->memberProfile?->passport_photo)
                            <img src="{{ asset('storage/' . $member->memberProfile->passport_photo) }}" class="w-16 h-16 rounded-lg object-cover flex-shrink-0">
                        @else
                        ...
                        @endif
                        <div class="min-w-0">
                            <h3 class="text-white font-medium truncate">{{ $member->name }}</h3>
                    ...
                    <div class="flex flex-wrap items-center gap-2 sm:flex-shrink-0">
                        <a href="{{ route('members.show', $member) }}" class="px-3 py-1.5 bg-gray-700 text-gray-300 rounded-lg text-sm hover:bg-gray-600 transition">View</a>
